gsmr_efo <- function(root="gsmr-efo")
{
  ...
  pheatmap(gsmr_mat,cluster_rows=FALSE,cluster_cols=FALSE,angle_col="315",fontsize_row=45,fontsize_col=23,
           display_numbers = dn, fontsize_number=15, legend_breaks = c(0.5, 1, 1.5))
