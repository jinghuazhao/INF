...
The list of proteins on inflammation is within one of the panels from [OLINK](https://www.olink.com/products/), each containing 92 proteins shown in [Olink validation data all panels.xlsx](doc/Olink%20validation%20data%20all%20panels.xlsx). Information contained in these panels can be retrieved into R via [OLINK.R](doc/OLINK.R), which also attempts to compromise earlier version and annotations.
