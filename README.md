...
6. Downstream analyses with PhenoScanner (preferably v2) and forest plots with respect to rsid as in [ps.sh](cardio/ps.sh) and/or on TRYGGVE for study-specific sumstats.
