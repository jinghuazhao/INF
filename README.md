...
4. Many functions are now part of R/gap ([CRAN](https://CRAN.R-project.org/package=gap), [GitHub](https://github.com/jinghuazhao/R/), [vignette](https://jinghuazhao.github.io/R/vignettes/gap.html)) ) or pQTLtools ([page](https://jinghuazhao.github.io/pQTLtools/), [functions](https://jinghuazhao.github.io/pQTLtools/reference/pQTLtools.html)).
