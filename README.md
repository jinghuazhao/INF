...
Jimmy's competitive log10(p) calculator is also documented in [log10p.md](doc/log10p.md) in comparison with R/Rmpfr. The cis.vs.trans.classification and log10p are both in [R/gap](https://github.com/jinghuazhao/R/tree/master/gap).
