...
6. Other downstream analyses such as employing PhenoScanner (preferably v2) and generating forest plots; both with respect to rsid as in [ps.sh](cardio/ps.sh) and/or on TRYGGVE for study-specific sumstats.
