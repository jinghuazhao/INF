...
png(paste0(pr,".png"),height=9,width=3.5,units="in",res=300)
par(mfrow=c(3,1))
with(snp, {
  lp <- -gap::log10p(beta/se)
  plot(pos,lp,cex=0.15,xlab="",ylab="-log10(P)",axes=FALSE)
  axis(2)
  plot(pos,prob,cex=0.15,xlab="",ylab="PIP",axes=FALSE)
  points(pos[prob>0.8],prob[prob>0.8],cex=0.15,col="red")
  axis(2)
  plot(pos,log10bf,cex=0.15,xlab="Position (MB)", ylab="log10(BF)", axes=FALSE)
  axis(1)
  axis(2)
})
dev.off()
