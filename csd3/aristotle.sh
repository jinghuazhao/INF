...
Rscript -e '
  ...
  legend(x=1,y=-0.5,c("cis","trans"),box.lwd=0,cex=2,col=c("red","blue"),pch=19)
  mtext("ARISTOTLE",side=2,line=4.5,cex=2)
  mtext("Meta-analysis",side=1,line=4.5,cex=2)
  mtext("Effect size (sd per allele)", side=1, line=3, cex=1.5)
  mtext("Effect size (sd per allele)", side=2, line=3, cex=1.5)
  abline(h=0,v=0)
