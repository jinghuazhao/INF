...
function llod()
{
  Rscript -e '
    ...
    calibrate::textxy(66,16,offset=0,pos=2,labs="IL-17C",cex=1.5,font=2,srt=0)
    arrows(67,16,71,16,lwd=2)
    axis(1, at=xtick, labels=pprot, lwd.tick=0.5, lwd=0, las=2, hadj=1, cex.axis=1.2)
    mtext("% samples above LLOD",side=2,line=2.5,cex=1.5)
    mtext("Ordered",side=1,line=1,cex=1.5,adj=0,font=1,at=-5)
    mtext("protein:",side=1,line=2,cex=1.5,adj=0,font=1,at=-5)
