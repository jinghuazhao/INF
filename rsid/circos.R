...
# circos.initializeWithIdeogram(cytoband=file.path(INF,"circos","cytoband.txt"), plotType = NULL, species = "hg19", chromosome.index = paste0("chr", 1:22))
  circos.initializeWithIdeogram(cytoband=file.path(INF,"circos","cytoband.txt"), plotType=NULL)
  circos.genomicLabels(pQTL_labels, labels.column = 4, side = "outside", cex = 0.3, line_lwd = 0.8,
