...
```{r gsmr, echo=FALSE, fig.align="left", fig.cap="Figure 1. GSMR results on TNFB", fig.height=24, fig.width=35, message=FALSE, warning=FALSE}
...
meta::forest(mg,colgap.forest.left = "0.5cm",fontsize=32,
             ...
             plotwidth="10inch",sortvar=Effect,
...
```{r wald, echo=FALSE, fig.cap="Figure 2. Single-SNP results", fig.height=24, fig.width=35, message=FALSE, warning=FALSE}
...
```{r ivw, echo=FALSE, fig.cap="Figure 3. IVW results", fig.height=24, fig.width=35, message=FALSE, warning=FALSE}
