...
efo <- read.xlsx(xlsx,sheet="EFO",startRow=2,colNames=TRUE,skipEmptyRows=TRUE) %>%
       select(-c(Zhengetal,uri))
efo_old <- filter(efo,is.na(Replacement) & grepl("ieu|ebi|finn-a-D3")) %>%
           select(-c(MRBASEID,Controls,Cases)))
