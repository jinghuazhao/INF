...
mr_all <- full_join(setNames(mr_results,c("id.outcome","b_single","se_single","p_single","disease")),
          ...
          left_join(select(efo_update,Ncases,Ncontrols)) %>%
          mutate(x=sign(b_single)*sign(b_IVW)) %>%
          select(disease,b_single,se_single,p_single,b_IVW,se_IVW,p_IVW,x,Ncases,Ncontrols)
...
![celiacdisease](ieu-a-276.png)
![sepsis](ieu-b-69.png)
![juvenileidiopathicarthritis](ebi-a-GCST005528.png)
![systemiclupuserythematosus](ebi-a-GCST003156.png)
![inflammatoryboweldisease](ieu-a-31.png)
![multiplesclerosis](ieu-b-18.png)
![IGAglomerulonephritis](ieu-a-1081.png)
![sclerosingcholangitis](ieu-a-1112.png)
![primarybiliarycirrhosis](ebi-a-GCST005581.png)
![asthma](ebi-a-GCST005212.png)
![atopiceczema](ieu-a-996.png)
![Crohn'sdisease](ebi-a-GCST004132.png)
![psoriasis](finn-b-L12_PSORIASIS.png)
![rheumatoidarthritis](ieu-a-833.png)
![ulcerativecolitis](ebi-a-GCST004133.png)
![ankylosingspondylitis](ebi-a-GCST005529.png)
![gout](ebi-a-GCST001790.png)
